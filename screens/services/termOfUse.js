    ...
    <View>
      ...
      <ScrollView
        ...
        <Text style={{marginBottom: 5}}>
          ...
          JARA for your own personal use subjected to restrictions set in these
        ...
        <Text style={{marginBottom: 5}}>
          ...
          JARA does not filter, edit, publish or review Comments prior to their
          ...
          the extent permitted by applicable laws, JARA shall not be liable for
        ...
        <Text style={{marginBottom: 5}}>
          You hereby grant JARA a non-exclusive license to use, reproduce, edit
        ...
        <Text style={{marginBottom: 5}}>
          ...
          the hyperlink compensates the absence of JARA; and (d) the link is in
        ...
        <Text style={{marginBottom: 5}}>
          ...
          sending an e-mail to JARA. Please include your name, your organization
        ...
        <Text style={{marginBottom: 5}}>By use of our corporate name; or</Text>
        <Text style={{marginBottom: 5}}>
