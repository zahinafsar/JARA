    ...
    <>
      <ScrollView style={{}}>
        ...
        <Text
          ...
          Are you fed up with the inconvenience of dismantling your laptop and
          ...
          come to you for the best onsite laptop repair services and help
        </Text>
        <Text
          style={{
            padding: 8,
        ...
        <View style={{margin: 13}}>
          <InfoBtn title="Hardware Service">
            <Text>1. Repair broken parts.</Text>
            <Text>2. Fix unknows issues.</Text>
            <Text>3. Laptop cleaning.</Text>
            <Text>4. Change Laptop Parts.</Text>
          </InfoBtn>
